...
presets = {
    "1": "-qoi -uber -unpack_qoi_to_png",
    "2": "-level 3 -lambda 1000",
    "3": "-level 4 -two_pass -lambda 600",
    "4": "-level 3 -two_pass -lambda 300",
    "5": "-level 6 -two_pass -lambda 1200",
    "6": "-two_pass"
}
...
def choose_preset():
    ...
    for key, value in presets.items():
        print(f"{key}: {value}")
    return input("Choose preset (1: Fast, 2: Slow, 3: Master Chief, 4: HFidelity Text, 5: Aliens, 6: Two Pass Simple): ")
